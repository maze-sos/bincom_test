...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 21, 2025 at 07:17 AM
...
CREATE TABLE `announced_pu_results` (
  ...
  `party_abbreviation` char(6) NOT NULL,
  `party_score` int(11) NOT NULL,
  `entered_by_user` varchar(50) NOT NULL,
  `date_entered` datetime NOT NULL,
  `user_ip_address` varchar(50) NOT NULL
...
(271, '282', 'PDP', 320, 'Admin', '2025-03-21 05:41:02', '127.0.0.1'),
(272, '282', 'DPP', 80, 'Admin', '2025-03-21 05:41:02', '127.0.0.1'),
(273, '282', 'ACN', 94, 'Admin', '2025-03-21 05:41:02', '127.0.0.1'),
(274, '282', 'PPA', 32, 'Admin', '2025-03-21 05:41:02', '127.0.0.1'),
(275, '282', 'CDC', 29, 'Admin', '2025-03-21 05:41:02', '127.0.0.1'),
(276, '282', 'JP', 45, 'Admin', '2025-03-21 05:41:02', '127.0.0.1'),
(277, '282', 'ANPP', 34, 'Admin', '2025-03-21 05:41:02', '127.0.0.1'),
(278, '283', 'PDP', 300, 'Admin', '2025-03-21 05:46:42', '127.0.0.1'),
(279, '283', 'DPP', 45, 'Admin', '2025-03-21 05:46:42', '127.0.0.1'),
(280, '283', 'ACN', 23, 'Admin', '2025-03-21 05:46:42', '127.0.0.1'),
(281, '283', 'PPA', 90, 'Admin', '2025-03-21 05:46:42', '127.0.0.1'),
(282, '283', 'CDC', 119, 'Admin', '2025-03-21 05:46:42', '127.0.0.1'),
(283, '283', 'JP', 31, 'Admin', '2025-03-21 05:46:42', '127.0.0.1'),
(284, '283', 'ANPP', 73, 'Admin', '2025-03-21 05:46:42', '127.0.0.1'),
(285, '283', 'LABOUR', 350, 'Admin', '2025-03-21 05:46:42', '127.0.0.1'),
(286, '283', 'CPP', 223, 'Admin', '2025-03-21 05:46:42', '127.0.0.1');
...
(282, 99, 10, 1, 12, 'DT1901669', 'Ezi High School', 'Ezi High School from Aniocha North', NULL, NULL, 'Admin', '2025-03-21 05:41:02', '127.0.0.1'),
(283, 199, 8, 2, 2, 'DT1901199', 'Ejeme High School', 'Ejeme High School in Aniocha South', NULL, NULL, 'Admin', '2025-03-21 05:46:42', '127.0.0.1');
...
('w4yDUAXZektNeg8r4ahQfRDaZ3vGL9twvYGguamw', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoicHd1S2pBQUowUUhaQnRNMDBvT2hmdFdGWWVWZmlqUldRNzBuM00yMiI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6Mjk6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC93ZWxjb21lIjt9fQ==', 1742537542);
...
--
ALTER TABLE `announced_pu_results`
  MODIFY `result_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=287;
...
--
ALTER TABLE `polling_unit`
  MODIFY `uniqueid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=284;
